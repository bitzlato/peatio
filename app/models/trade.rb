...
class Trade < ApplicationRecord
  ...
  def trigger_event
    ...
    ::AMQP::Queue.enqueue('trade_completed', for_notify(maker).merge(member_uid: maker.uid, other_member_uid: taker.uid))
    ::AMQP::Queue.enqueue('trade_completed', for_notify(taker).merge(member_uid: taker.uid, other_member_uid: maker.uid))
  end
