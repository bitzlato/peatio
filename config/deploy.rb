...
set :systemd_daemon_instances, -> { %i[cron_job blockchain global_state withdraw_audit slave_book] }

set :systemd_amqp_daemon_role, :daemons
set :systemd_amqp_daemon_instances, -> { %i[deposit_coin_address deposit_collection deposit_collection_fees withdraw_coin deposit_intention matching pusher_market market_ticker pusher_member order_processor trade_executor influx_writer] }
