...
set :systemd_daemon_instances, -> { %i[bargainer_job blockchain collector currency_pricer gas_price_checker k_line liabilities_compactor payment_address_balancer remove_invoiced_deposits stats_member_pnl ticker transfers_polling wallet_balances] }
