...
set :systemd_daemon_instances,
    %i[bargainer_job currency_pricer gas_price_checker k_line liabilities_compactor payment_address_balancer stats_member_pnl ticker wallet_balances swap_order_status_checker]
