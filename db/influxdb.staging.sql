CREATE DATABASE peatio_staging;

CREATE CONTINUOUS QUERY "trade_to_cq_1m" ON peatio_staging
...
CREATE CONTINUOUS QUERY "candles_1m_to_cq_1m" ON peatio_staging
...
CREATE CONTINUOUS QUERY "cq_5m" ON peatio_staging
...
CREATE CONTINUOUS QUERY "cq_15m" ON peatio_staging
...
CREATE CONTINUOUS QUERY "cq_30m" ON peatio_staging
...
CREATE CONTINUOUS QUERY "cq_1h" ON peatio_staging
...
CREATE CONTINUOUS QUERY "cq_2h" ON peatio_staging
...
CREATE CONTINUOUS QUERY "cq_4h" ON peatio_staging
...
CREATE CONTINUOUS QUERY "cq_6h" ON peatio_staging
...
CREATE CONTINUOUS QUERY "cq_12h" ON peatio_staging
...
CREATE CONTINUOUS QUERY "cq_1d" ON peatio_staging
...
CREATE CONTINUOUS QUERY "cq_3d" ON peatio_staging
...
CREATE CONTINUOUS QUERY "cq_1w" ON peatio_staging
