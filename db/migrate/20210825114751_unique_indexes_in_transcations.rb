class UniqueIndexesInTranscations < ActiveRecord::Migration[5.2]
  def change
    ...
    add_index :transactions, [:blockchain_id, :txid], where: 'txout is null', unique: true
    add_index :transactions, [:blockchain_id, :txid, :txout], where: 'txout is not null', unique: true
