...
describe 'Ethereum::Eth::Blockchain' do
  ...
  # before do
  # Wallet.find_by(blockchain: blockchain, kind: 'hot').update(address: '0x3760868c53f570fdfb19413170736f34e5506229')
  # end
  ...
  # subject { blockchain.gateway.fetch_block(start_block) }
